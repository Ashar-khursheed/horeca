...
//         'specs_sheet' => 'array', // Ensure the JSON field is cast to an array
//     ];

    
//     protected static function booted(): void
//     {
//         static::creating(function (TempProduct $product) {
//             $product->created_by_id = Auth::check() ? Auth::id() : 0;
//             $product->created_by_type = User::class;
//         });

//         static::deleted(function (TempProduct $product) {
...
//         static::updated(function (TempProduct $product) {
...
//                 fn (TempProduct $product) => ! $product->pivot->is_variant
//             );
//         });
//     }
...
//                 'temp_products.name',
//                 'temp_products.image',
//                 'temp_products.images',
//                 'temp_products.sku',
//                 'temp_products.is_variation',
...
//                     ->whereColumn('temp_products.id', 'ec_product_variations.product_id')
...
//                     ->selectRaw('COUNT(*)')
//                     ->whereColumn('temp_products.id', 'ec_product_variations.configurable_product_id')
//                     ->groupBy('configurable_product_id'),
//             ])
//             ->leftJoin('ec_product_variations', function (JoinClause $join) {
//                 $join
//                     ->on('temp_products.id', '=', 'ec_product_variations.product_id')
//                     ->where('temp_products.is_variation', 1);
//             })
//             ->orderBy('name')
